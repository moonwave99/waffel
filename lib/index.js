...
var Backend, EventEmitter, Promise, Waffel, _, async, cheerio, colors, exec, filters, fs, glob, helpers, i18n, markdown, marked, matter, md5, moment, nunjucks, path, pushserve, util, yaml,
    ...
    return this.getRevision().then((function(_this) {
      ...
      return function() {
        return new Promise(function(resolve, reject) {
          ...
          _this.i18n = t;
          return glob.callAsync(_this, _path).then(function(files) {
