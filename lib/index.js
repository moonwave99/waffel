...
module.exports = Waffel = (function(superClass) {
  ...
  Waffel.prototype.generate = function(options) {
    var dataPath, debounced_generate, localesPath, viewPath;
    if (options == null) {
      options = {};
    }
    this.log("--> Start generation process...\n---");
    dataPath = path.join(this.options.dataFolder, "**/*" + this.options.dataExt);
    if (this.options.watch) {
      ...
      debounced_generate = _.debounce((function(_this) {
        return function() {
          return _this._generate(dataPath, options, _this.options.watchInterval);
        };
      })(this));
      this.watcher = chokidar.watch([dataPath, localesPath, viewPath]);
      this.watcher.on('change', debounced_generate);
    }
    return this._generate(dataPath, options);
  };
  ...
  Waffel.prototype._generate = function(_path, options) {
    return this._loadLocales().then((function(_this) {
      return function() {
        ...
        return _this._getFiles(_path).then(function(data) {
          _this.data = data;
          if (options.data) {
