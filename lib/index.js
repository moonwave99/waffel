...
var Backend, EventEmitter, Promise, Waffel, _, async, cheerio, chokidar, colors, exec, filters, fs, glob, helpers, i18n, markdown, marked, matter, md5, moment, nunjucks, path, pushserve, util, utils, yaml,
...
module.exports = Waffel = (function(superClass) {
  ...
  Waffel.prototype._getFiles = function(_path) {
    ...
    return glob(_path).then((function(_this) {
